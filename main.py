...
def generate_standalone_question_with_llm(api_key, endpoint_url, api_version, deployment_name, new_question, db_name="qa_database.db"):
    ...
    if last_question and last_answer:
        prompt = (
            ...
            f"Here is the previous question \n"
            f"Q: {last_question}\n"
            f"Now, here is the new question: {new_question}\n\n"
            f"Generate a standalone question that incorporates the context of the previous question."
        )
    else:
        return new_question
...
if __name__ == "__main__":
    ...
    # User Query
    user_query = "which weapon is the speaker referring about?"
